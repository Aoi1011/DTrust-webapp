...
const usedtrustAlarmstyles = makeStyles((theme) => ({
  pageTitle: {
...
export default function dtrustAlarm(props) {
  const classes = usedtrustAlarmstyles();
